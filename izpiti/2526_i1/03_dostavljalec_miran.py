...
# Dostavljalec Miran
#
# Spletna trgovina ima organizirano svojo dostavo naročenega blaga strankam.
# Miran je zelo zanesljiv dostavljalec, žal pa nekoliko peša njegovo znanje 
# logistike, zato vas prosi za pomoč.
# =====================================================================@044781=
# 1. podnaloga
...
def _validate_current_file():
        ...
        try:
            podatki = [
                ...
                (
                    "zemljevid2.txt", 
                    ["....#..", ".......", "#......", "....##.", "...#.##", ".......", ".......", "..#....", "#......", "......#"], 
                    {(0, 4), (2, 0), (3, 4), (3, 5), (4, 3), (4, 5), (4, 6), (7, 2), (8, 0), (9, 6)}
                ),
            ]
            for vhod_ime, vhod_vsebina, rezultat in podatki:
                with Check.in_file(vhod_ime, vhod_vsebina):
                    if not Check.equal(f"poisci_stranke({vhod_ime!r})", rezultat):
                        break
        except TimeoutError:
    ...
    if Check.part():
        ...
        try:
            podatki = [
                ((1, 1), [(2, 4), (1, 4), (4, 9)], (1, 4)),
                ((5, 9), [(2, 4), (9, 4), (4, 9), (4, 8)], (4, 9)),
                ((2, 2), [(1, 0), (1, 1), (3, 3), (1, 3), (3, 1)], (1, 1)),
                ((2, 8), [], None),
            ]
            for centrala, stranke, rezultat in podatki:
                if not Check.equal(f"najblizja_stranka({centrala}, {stranke})", rezultat):
                    break
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
        ...
        try:
            podatki = [
                (
                    (4, 5), 
                    "zemljevid.txt", ["...#....", ".#.....#", "........", "........", ".#......"],
                    "izhod.txt", ["(4, 5) ==3.61==> (1, 7)", "(4, 5) ==4.00==> (4, 1)", "(4, 5) ==4.47==> (0, 3)", "(4, 5) ==5.00==> (1, 1)"],
                    [(1, 7), (4, 1), (0, 3), (1, 1)]
                ),
                (
                    (3, 2),
                    "zemljevid2.txt", ["....#..", ".......", "#......", "....##.", "...#.##", ".......", ".......", "..#....", "#......", "......#"],
                    "izhod2.txt", ["(3, 2) ==1.41==> (4, 3)", "(3, 2) ==2.00==> (3, 4)", "(3, 2) ==2.24==> (2, 0)", "(3, 2) ==3.00==> (3, 5)", "(3, 2) ==3.16==> (4, 5)", "(3, 2) ==3.61==> (0, 4)", "(3, 2) ==4.00==> (7, 2)", "(3, 2) ==4.12==> (4, 6)", "(3, 2) ==5.39==> (8, 0)", "(3, 2) ==7.21==> (9, 6)"],
                    [(4, 3), (3, 4), (2, 0), (3, 5), (4, 5), (0, 4), (7, 2), (4, 6), (8, 0), (9, 6)]
                ),
            ]
            for centrala, vhod_ime, vhod_vsebina, izhod_ime, izhod_vsebina, rezultat in podatki:
                with Check.in_file(vhod_ime, vhod_vsebina):
                    if not Check.equal(f"uredi_stranke({centrala}, {vhod_ime!r}, {izhod_ime!r})", rezultat) or not Check.out_file(izhod_ime, izhod_vsebina):
                        break
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
